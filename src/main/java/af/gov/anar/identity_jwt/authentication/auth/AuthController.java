...
import af.gov.anar.identity_jwt.authentication.user.CustomUserService;
import af.gov.anar.identity_jwt.authentication.user.User;
import af.gov.anar.identity_jwt.authentication.user.UserAuthService;
...
public class AuthController {
    ...
    public ResponseEntity login(@RequestBody Map<String, String> loginUser) throws AuthenticationException {
        ...
        eventLogService.log(userService.getLoggedInUser().getId(), customUser.getCurrentEnv() ,this.getClass().getName() , "INFO", null, userService.getLoggedInUser().toString());
